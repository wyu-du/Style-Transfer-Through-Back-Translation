...
class Translator(object):
    def __init__(self, opt):
        ...
        checkpoint = torch.load(opt.decoder_model, map_location=lambda storage, loc: storage.cuda())
        encoder_check = torch.load(opt.encoder_model, map_location=lambda storage, loc: storage.cuda())
